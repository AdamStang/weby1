...
function animelektricka2(x) {
	...
	x.classList.remove("stopelektricka2");
		...
		function demo() {
			var a = document.getElementById("elektr1");
			var b = document.getElementById("elektr2");
			var c = document.getElementById("auto1");

			animelektricka1(a);
			sleep(0).then(() => { 	animelektricka2(b); });
			sleep(2000).then(() => { 	animauto1(c); });
		}	
